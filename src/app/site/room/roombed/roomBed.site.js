...
var RoomBedSite = (function (_super) {
    __extends(RoomBedSite, _super);
    //Method
    function RoomBedSite(globalConstant, router, dataService) {
    ...
    RoomBedSite.prototype.filterData = function () {
    ...
    RoomBedSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getRoomBedAllTable(pageNumber, pageSize, sort, filter1);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    RoomBedSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(RoomBedSite.prototype, "diagnostic", {
...
exports.RoomBedSite = RoomBedSite;
//# sourceMappingURL=roombed.site.js.map