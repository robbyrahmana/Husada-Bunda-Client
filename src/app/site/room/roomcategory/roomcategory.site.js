...
var RoomCategorySite = (function (_super) {
    __extends(RoomCategorySite, _super);
    //Method
    function RoomCategorySite(globalConstant, router, dataService) {
        ...
        _this.filter1 = "";
        _this.filter2 = "";
        _this.generateConfig("roomcategory");
        var observable = _this.fetchPage(0, 10, null, "", "");
        _this.self = _this;
        return _this;
    }
    RoomCategorySite.prototype.filterData = function () {
    ...
    RoomCategorySite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getRoomCategoryAllTable(pageNumber, pageSize, sort, filter1, filter2);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    RoomCategorySite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(RoomCategorySite.prototype, "diagnostic", {
        get: function () { return JSON.stringify(this.dataPage); },
        enumerable: true,
        configurable: true
    });
    return RoomCategorySite;
}(list_helper_1.ListHelper));
RoomCategorySite = __decorate([
    core_1.Component({
        templateUrl: './roomCategory.site.html'
    }),
    __metadata("design:paramtypes", [globalConstant_1.GlobalConstant, router_1.Router, room_service_1.RoomService])
], RoomCategorySite);
exports.RoomCategorySite = RoomCategorySite;
//# sourceMappingURL=roomCategory.site.js.map