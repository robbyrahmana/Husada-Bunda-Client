...
var RoomCategoryModifySite = (function (_super) {
    __extends(RoomCategoryModifySite, _super);
    function RoomCategoryModifySite(globalConstant, route, router, dataService) {
        var _this = _super.call(this, globalConstant, route, router, dataService) || this;
        _this.dataContainer = new room_domain_1.RoomCategory();
        _this.generateConfig("roomcategory");
        _this.route.params.subscribe(function (params) {
            if (params['id'] != null) {
                _this.editMode = _this.globalConstant.setEditMode(true);
                _this.newEntry = false;
                _this.dataService.getRoomCategoryByID(params['id']).subscribe(function (data) {
    ...
    RoomCategoryModifySite.prototype.submit = function () {
        var _this = this;
        this.error = null;
        var observable;
        if (this.newEntry) {
    ...
    return RoomCategoryModifySite;
}(edit_helper_1.EditHelper));
RoomCategoryModifySite = __decorate([
    core_1.Component({
...
], RoomCategoryModifySite);
exports.RoomCategoryModifySite = RoomCategoryModifySite;
//# sourceMappingURL=roomCategoryModify.site.js.map