...
var TreatmentBodyModifySite = (function (_super) {
    __extends(TreatmentBodyModifySite, _super);
    function TreatmentBodyModifySite(globalConstant, route, router, dataService) {
        var _this = _super.call(this, globalConstant, route, router, dataService) || this;
        _this.dataContainer = new treatment_domain_1.TreatmentBody();
        _this.generateConfig("treatmentbody");
        _this.route.params.subscribe(function (params) {
            //get treatment header
            var observable = _this.dataService.getTreatmentHeaderAllData();
            observable.subscribe(function (data) {
                _this.treatmentheader = new treatment_domain_1.TreatmentHeader();
                _this.treatmentheader = data;
            });
            if (params['id'] != null) {
                _this.editMode = _this.globalConstant.setEditMode(true);
                _this.newEntry = false;
                _this.dataService.getTreatmentBodyByID(params['id']).subscribe(function (data) {
                    _this.dataContainer = data;
                    _this.treatmentheaderid = _this.dataContainer.treatmentHeaderEntity.id;
                });
            }
            else {
    ...
    TreatmentBodyModifySite.prototype.submit = function () {
        var _this = this;
        this.error = null;
        var observable;
        if (this.newEntry) {
    ...
    TreatmentBodyModifySite.prototype.getValue = function (id) {
        this.treatmentheaderid = id;
        return this.treatmentheader.find(function (x) { return x.id === id; });
    };
    return TreatmentBodyModifySite;
}(edit_helper_1.EditHelper));
TreatmentBodyModifySite = __decorate([
    core_1.Component({
...
], TreatmentBodyModifySite);
exports.TreatmentBodyModifySite = TreatmentBodyModifySite;
//# sourceMappingURL=treatmentbodyModify.site.js.map