...
var TreatmentHeaderSite = (function (_super) {
    __extends(TreatmentHeaderSite, _super);
    //Method
    function TreatmentHeaderSite(globalConstant, router, dataService) {
    ...
    TreatmentHeaderSite.prototype.filterData = function () {
    ...
    TreatmentHeaderSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getTreatmentHeaderAllTable(pageNumber, pageSize, sort, filter1, filter2);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    TreatmentHeaderSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(TreatmentHeaderSite.prototype, "diagnostic", {
        get: function () { return JSON.stringify(this.dataPage); },
        enumerable: true,
        configurable: true
    });
    return TreatmentHeaderSite;
}(list_helper_1.ListHelper));
TreatmentHeaderSite = __decorate([
    core_1.Component({
...
exports.TreatmentHeaderSite = TreatmentHeaderSite;
//# sourceMappingURL=treatmentheader.site.js.map