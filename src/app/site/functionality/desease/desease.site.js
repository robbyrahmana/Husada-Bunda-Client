...
var DeseaseSite = (function (_super) {
    __extends(DeseaseSite, _super);
    //Method
    function DeseaseSite(globalConstant, router, dataService) {
    ...
    DeseaseSite.prototype.filterData = function () {
    ...
    DeseaseSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getDeseaseAllTable(pageNumber, pageSize, sort, filter1, filter2);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    DeseaseSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(DeseaseSite.prototype, "diagnostic", {
...
DeseaseSite = __decorate([
    core_1.Component({
        templateUrl: './desease.site.html'
    }),
    __metadata("design:paramtypes", [globalConstant_1.GlobalConstant, router_1.Router, functionality_service_1.FunctionalityService])
], DeseaseSite);
exports.DeseaseSite = DeseaseSite;
//# sourceMappingURL=desease.site.js.map