...
var InsuranceSite = (function (_super) {
    __extends(InsuranceSite, _super);
    //Filter purpose
    //Method
    function InsuranceSite(globalConstant, router, dataService) {
    ...
    InsuranceSite.prototype.filterData = function () {
        this.fetchPage(0, 10, null);
        this.paginationData = new paginationdata_domain_1.PaginationData(0, 5, 1, 10);
    };
    InsuranceSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getInsuranceAllTable(pageNumber, pageSize, sort);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    InsuranceSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(InsuranceSite.prototype, "diagnostic", {
...
exports.InsuranceSite = InsuranceSite;
//# sourceMappingURL=insurance.site.js.map