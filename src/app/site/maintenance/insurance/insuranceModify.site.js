...
var InsuranceModifySite = (function (_super) {
    __extends(InsuranceModifySite, _super);
    function InsuranceModifySite(globalConstant, route, router, dataService) {
        var _this = _super.call(this, globalConstant, route, router, dataService) || this;
        _this.dataContainer = new maintenance_domain_1.Insurance();
        _this.generateConfig("insurance");
        _this.route.params.subscribe(function (params) {
            if (params['id'] != null) {
                _this.editMode = _this.globalConstant.setEditMode(true);
                _this.newEntry = false;
                _this.dataService.getInsuranceByID(params['id']).subscribe(function (data) {
    ...
    InsuranceModifySite.prototype.submit = function () {
        var _this = this;
        this.error = null;
        var observable;
        if (this.newEntry) {
            delete this.dataContainer.id;
            observable = this.dataService.saveInsuranceRecord(this.dataContainer);
        }
        else {
            observable = this.dataService.updateInsuranceRecord(this.dataContainer);
        }
    ...
    return InsuranceModifySite;
}(edit_helper_1.EditHelper));
InsuranceModifySite = __decorate([
    core_1.Component({
        templateUrl: './insuranceModify.site.html'
    }),
...
exports.InsuranceModifySite = InsuranceModifySite;
//# sourceMappingURL=insuranceModify.site.js.map