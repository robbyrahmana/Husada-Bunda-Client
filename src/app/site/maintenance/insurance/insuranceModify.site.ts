...
export class InsuranceModifySite extends EditHelper implements Edit{
    
    dataContainer: Insurance = new Insurance();
    Insurance: any;
    Insuranceid: any;
    ...
    constructor(globalConstant: GlobalConstant, route: ActivatedRoute, router: Router, dataService : MaintenanceService) {
        ...
        this.route.params.subscribe(params => {
            ...
            if (params['id'] != null) {
                ...
                this.newEntry = false;
                this.dataService.getInsuranceByID(params['id']).subscribe(data => {
    ...
    submit() {
        this.error = null;
        let observable:Observable<Insurance>;
        if (this.newEntry) {
