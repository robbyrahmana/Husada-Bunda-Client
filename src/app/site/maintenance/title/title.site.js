...
var TitleSite = (function (_super) {
    __extends(TitleSite, _super);
    //Filter purpose
    //Method
    function TitleSite(globalConstant, router, dataService) {
        ...
        _this.generateConfig("title");
        var observable = _this.fetchPage(0, 10, null, "");
        _this.self = _this;
        return _this;
    }
    TitleSite.prototype.filterData = function () {
        this.fetchPage(0, 10, null);
        this.paginationData = new paginationdata_domain_1.PaginationData(0, 5, 1, 10);
    };
    TitleSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getTitleAllTable(pageNumber, pageSize, sort);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    TitleSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(TitleSite.prototype, "diagnostic", {
...
TitleSite = __decorate([
    core_1.Component({
        templateUrl: './title.site.html'
    }),
...
//# sourceMappingURL=title.site.js.map