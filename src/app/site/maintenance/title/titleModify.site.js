...
var TitleModifySite = (function (_super) {
    __extends(TitleModifySite, _super);
    function TitleModifySite(globalConstant, route, router, dataService) {
        var _this = _super.call(this, globalConstant, route, router, dataService) || this;
        _this.dataContainer = new maintenance_domain_1.Title();
        _this.generateConfig("title");
        _this.route.params.subscribe(function (params) {
            if (params['id'] != null) {
                _this.editMode = _this.globalConstant.setEditMode(true);
                _this.newEntry = false;
                _this.dataService.getTitleByID(params['id']).subscribe(function (data) {
    ...
    TitleModifySite.prototype.submit = function () {
        var _this = this;
        this.error = null;
        var observable;
        if (this.newEntry) {
    ...
    return TitleModifySite;
}(edit_helper_1.EditHelper));
TitleModifySite = __decorate([
    core_1.Component({
...
exports.TitleModifySite = TitleModifySite;
//# sourceMappingURL=titleModify.site.js.map