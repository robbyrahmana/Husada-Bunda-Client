...
var BloodGroupSite = (function (_super) {
    __extends(BloodGroupSite, _super);
    //Filter purpose
    //Method
    function BloodGroupSite(globalConstant, router, dataService) {
    ...
    BloodGroupSite.prototype.filterData = function () {
        this.fetchPage(0, 10, null);
        this.paginationData = new paginationdata_domain_1.PaginationData(0, 5, 1, 10);
    };
    BloodGroupSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getBloodGroupAllTable(pageNumber, pageSize, sort);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    BloodGroupSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(BloodGroupSite.prototype, "diagnostic", {
        get: function () { return JSON.stringify(this.dataPage); },
        enumerable: true,
        configurable: true
    });
    return BloodGroupSite;
}(list_helper_1.ListHelper));
BloodGroupSite = __decorate([
    core_1.Component({
...
exports.BloodGroupSite = BloodGroupSite;
//# sourceMappingURL=bloodGroup.site.js.map