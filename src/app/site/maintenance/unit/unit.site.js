...
var UnitSite = (function (_super) {
    __extends(UnitSite, _super);
    //Filter purpose
    //Method
    function UnitSite(globalConstant, router, dataService) {
        ...
        _this.generateConfig("unit");
        var observable = _this.fetchPage(0, 10, null, "");
        _this.self = _this;
        return _this;
    }
    UnitSite.prototype.filterData = function () {
        this.fetchPage(0, 10, null);
        this.paginationData = new paginationdata_domain_1.PaginationData(0, 5, 1, 10);
    };
    UnitSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getUnitAllTable(pageNumber, pageSize, sort);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    UnitSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(UnitSite.prototype, "diagnostic", {
...
exports.UnitSite = UnitSite;
//# sourceMappingURL=unit.site.js.map