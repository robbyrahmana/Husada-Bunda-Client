...
var UnitModifySite = (function (_super) {
    __extends(UnitModifySite, _super);
    function UnitModifySite(globalConstant, route, router, dataService) {
        var _this = _super.call(this, globalConstant, route, router, dataService) || this;
        _this.dataContainer = new maintenance_domain_1.Unit();
        _this.generateConfig("unit");
        _this.route.params.subscribe(function (params) {
            if (params['id'] != null) {
                _this.editMode = _this.globalConstant.setEditMode(true);
                _this.newEntry = false;
                _this.dataService.getUnitByID(params['id']).subscribe(function (data) {
    ...
    UnitModifySite.prototype.submit = function () {
        var _this = this;
        this.error = null;
        var observable;
        if (this.newEntry) {
    ...
    return UnitModifySite;
}(edit_helper_1.EditHelper));
UnitModifySite = __decorate([
    core_1.Component({
...
exports.UnitModifySite = UnitModifySite;
//# sourceMappingURL=unitModify.site.js.map