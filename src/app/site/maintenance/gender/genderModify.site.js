...
var GenderModifySite = (function (_super) {
    __extends(GenderModifySite, _super);
    function GenderModifySite(globalConstant, route, router, dataService) {
        var _this = _super.call(this, globalConstant, route, router, dataService) || this;
        _this.dataContainer = new maintenance_domain_1.Gender();
        _this.generateConfig("gender");
        _this.route.params.subscribe(function (params) {
            if (params['id'] != null) {
                _this.editMode = _this.globalConstant.setEditMode(true);
                _this.newEntry = false;
                _this.dataService.getGenderByID(params['id']).subscribe(function (data) {
    ...
    GenderModifySite.prototype.submit = function () {
        var _this = this;
        this.error = null;
        var observable;
        if (this.newEntry) {
    ...
    return GenderModifySite;
}(edit_helper_1.EditHelper));
GenderModifySite = __decorate([
    core_1.Component({
...
exports.GenderModifySite = GenderModifySite;
//# sourceMappingURL=genderModify.site.js.map