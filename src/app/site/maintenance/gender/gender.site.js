...
var GenderSite = (function (_super) {
    __extends(GenderSite, _super);
    //Filter purpose
    //Method
    function GenderSite(globalConstant, router, dataService) {
        ...
        _this.generateConfig("gender");
        var observable = _this.fetchPage(0, 10, null, "");
        _this.self = _this;
        return _this;
    }
    GenderSite.prototype.filterData = function () {
        this.fetchPage(0, 10, null);
        this.paginationData = new paginationdata_domain_1.PaginationData(0, 5, 1, 10);
    };
    GenderSite.prototype.fetchPage = function (pageNumber, pageSize, sort, filter1, filter2, filter3, filter4, filter5) {
        var _this = this;
        ...
        var observable = this.dataService.getGenderAllTable(pageNumber, pageSize, sort);
        observable.subscribe(function (dataPage) {
            _this.dataPage = dataPage;
        });
        return observable;
    };
    GenderSite.prototype.delete = function (data) {
        alert("Delete" + data);
    };
    Object.defineProperty(GenderSite.prototype, "diagnostic", {
